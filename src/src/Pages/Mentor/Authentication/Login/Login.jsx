...
import { useLoginMentorMutation } from "../../../../redux/Apis/Mentor/mentorSlice";

const Login = () => {
  const [LoginMentor] = useLoginMentorMutation();
  const [mentor, setMentor] = useState({
    email: "",
    password: "",
  });
  const { email, password } = mentor;
  ...
  const handleSubmit = async(e) => {
    ...
    if (!passwordRegex.test(password)) {
      ...
      const response=await LoginMentor({...mentor})
