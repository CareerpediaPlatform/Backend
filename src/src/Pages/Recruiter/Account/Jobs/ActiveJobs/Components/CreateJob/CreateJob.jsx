...
const CreateJob = () => {
  ...
  return (
    <div className="recruiter-create-dashboard">
      <Sidebar />
        ...
        >
          <div className="create-job">
            ...
            <div className="creation">
              ...
              <div className="right-creation">
                <div className="create-checkbox-fields">
            ...
            <div className="creation">
              ...
              <div className="right-creation">
                <div className="create-radio-fields">
                ...
                <div className="create-interview-fields">
