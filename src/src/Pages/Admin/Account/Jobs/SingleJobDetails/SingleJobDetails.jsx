...
const SingleJobDetails = () => {
  ...
  return (
    <div className="admin-single-jobs">
      <Sidebar />
      <div className="admin-single-job-content">
        <Navbar type="job" />
        <div
        ...
        >
          <div className="single-job-info">
            <div className="jobs-go-arrow">
              <p>Jobs {arrow} Job Overview</p>
            </div>

            <div className="jobs-image">
              <img src={RectangleImage} alt="jobImage" />
              {SingleJobData.map((singleJob, index) => {
                return (
                  <div className="job-location" key={index}>
