...
router.route('/upload-assignment/:partId').post((0, video_upload_1.videoFileReader)(api_param_constants_1.FormParams.FILE_FIELD, 1), file_1.emptyChecks, controller.uploadAssignment);
