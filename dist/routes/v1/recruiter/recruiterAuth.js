...
const APIPaths = __importStar(require("../../../constants/api_path_constants"));
const controller = __importStar(require("../../../controller/recruiter/recruiterAuth"));
...
router.route(APIPaths.LOGIN)
    .post(validation.SignIn, validation.recruiterLimiter, controller.loginRecruiter);
router.route('/signup')
